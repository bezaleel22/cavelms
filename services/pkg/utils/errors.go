...
var (
	...
	ErrUnableToParseMailTemplate = errors.New("error: Unable to parse email template")
	ErrUnableToOpenFile          = errors.New("error: Unable to open file")
	ErrMailNotSent               = errors.New("error: Unable to send mail")
