<script lang="ts">
  ...
  let items = [
    { id: "", title: "Overview", component: Overview },
    { id: "", title: "Videos", component: Videos },
    { id: "", title: "Documents", component: Documents },
    { id: "", title: "Assignments", component: Assignments },
    { id: "", title: "Forum", component: Forum },
  ];
</script>
