...
<div class="breadcrumb-wrap-style-2" data-bg-image="images/media/slide/5.png">
...
<section class="about-wrap-style-6 motion-effects-wrap">
  <div class="container">
    <div class="section-heading style-12">
      ...
      <h2 class="title">About Adullam</h2>
    </div>
...
<section class="brand-wrap-style-1">
  <div class="container">
    ...
    <div class="inner-wrap" data-bg-image="images/media/elements/element12.png">
      <div class="row justify-content-center align-items-center">
        <h5>
          ...
          from Gath, which was the scene of David’s memorable victory over Goliath (1Samuel 17:2). <br
          />The Cave of Adullam became a place of resort for David. It was the location where all
          that were stranded, discourage and had given up on life resorted to David to find meaning
          (1Sam. 22:1-2). <br />Adullam became a forge where charlatans are turned into champions,
          ...
          It is a training and equipping that is imparting, intellectual, and rigorous. <br />A
          program characteristic of an academic rigor alongside a high spiritual engagement.
        </h5>
      </div>
    </div>
  </div>
