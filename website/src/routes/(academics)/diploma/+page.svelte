                ...
                <li>
                  <div class="content-box">
                    ...
                    <h6 class="description">
                      ...
                      - Two referees<br />
                      - All International students that wish to learn On-Campus are required to apply
                      for and secure a student visa for the duration of their study in the Nigerian Embassy
                      in their country before travelling in
                      <br />
                      <hr />
                      ...
                      <hr />
                      <strong>
                        NB. If you desire to benefit from the scholarship, please indicate interest
                        in the Scholarship Section made available while you fill the application
                        form for your respective program
                      </strong>
                      <hr />
                      <br />
                      ...
                      <br /><br />
                      <a
                        href="https://portal.adullam.ng/signup/register"
          ...
          <div class="col-xl-6 col-12">
            <div class="about-box style-3">
              <div class="figure-box">
                <img src="/images/media/banner/banner9.png" alt="Baneer" width="930" height="815" />
              </div>
