...
<section class="about-wrap-style-6 motion-effects-wrap">
  <div class="container">
    <div class="section-heading style-12">
      <div class="sub-title">Remnant Chritian Network</div>
      <h2 class="title">The Embassy</h2>
    </div>
          ...
          <ul class="block-list about-list">
            <li>
              ...
              <div class="content-box">
                <h2 class="title">Apostle. Arome Osayi.</h2>
                <div class="d-flex align-items-center mb-4">
                  <div class="designation">
                    <strong>The Set-Man(Remnant Christian Network)</strong>
                  </div>
                </div>
